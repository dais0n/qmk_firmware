...
[_QWERTY] = LAYOUT_split_3x5_3(
  ...
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                    MT(MOD_LGUI, KC_ESC), LT(LOWER, KC_SPC), MT(MOD_LCTL, KC_ESC),   MT(MOD_LSFT, KC_TAB), LT(RAISE, KC_TAB), MT(MOD_LALT, KC_BSPC)
),
...
[_RAISE] = LAYOUT_split_3x5_3(
  ...
  KC_CAPS, KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,       KC_SCLN, KC_QUOT, KC_LT,   KC_LBRC, KC_RBRC,
                    _______, _______, _______,      XXXXX, XXXXX, XXXXX 
),
...
[_LOWER] = LAYOUT_split_3x5_3(
  ...
  KC_TAB,  _______, KC_UP, _______, _______,        KC_MINS, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,
  KC_LCTL, KC_LEFT,  KC_PGDN, KC_RGHT, KC_DEL,      KC_PLUS, KC_PGUP, KC_PGDN, KC_BSLS, KC_ENT,
